...
const HolidayHeader = () => (
  <header className="w-full text-center lg:-ml-[850px] md:-ml-[420px] ">
...
const SimilarExperience: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center mt-[50px] lg:mr-14 w-full max-w-[1440px] mx-auto overflow-x-hidden lg:mb-[100px] mb-[80px]">
      <HolidayHeader />
      {/* Cards */}
